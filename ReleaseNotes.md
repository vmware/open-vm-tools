#                      open-vm-tools 12.5.4 Release Notes

Updated on: 29 Sep 2025

open-vm-tools | 29 SEP 2025 | Build 24964629
...
*   A complete list of the granular changes in the open-vm-tools 12.5.4 release is available at:

    [open-vm-tools ChangeLog](https://github.com/vmware/open-vm-tools/blob/stable-12.5.4/open-vm-tools/ChangeLog)

## <a id="i18n" name="i18n"></a>Internationalization

open-vm-tools 12.5.4 is available in the following languages:
