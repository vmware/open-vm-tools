...
/*
 * vgauthService_version.h --
 *
 * Version definitions for the vgauthService program
 */

#ifndef _VGAUTHSERVICE_VERSION_H_
#define _VGAUTHSERVICE_VERSION_H_
...
#define VGAUTHSERVICE_VERSION_COMMAS   TOOLS_VERSION_EXT_CURRENT_CSV
#define VGAUTHSERVICE_VERSION_STRING   TOOLS_VERSION_EXT_CURRENT_STR
