...
/**
 * @ingroup IntObj
 * @brief An implementation of Caf::AmqpIntegration::SecureConnectionFactory that returns
 ...
 * <p>
 * SecureCachingConnectionFactory objects are created by inserting the following into
 * the application context:
 * <pre>
 *
 * \<bean
 * 	id="secureConnectionFactory"
 ...
 * </table>
 */
class SecureCachingConnectionFactoryObj :
	public TCafSubSystemObjectRoot<SecureCachingConnectionFactoryObj>,
	public IBean,
	public ConnectionFactory
	{
	CAF_DECLARE_OBJECT_IDENTIFIER(_sObjIdAmqpSecureCachingConnectionFactory)

	CAF_BEGIN_INTERFACE_MAP(SecureCachingConnectionFactoryObj)
...
public:
	...
	virtual ~SecureCachingConnectionFactoryObj();
...
private:
	...
	CAF_CM_CREATE;
	CAF_CM_CREATE_LOG;
	CAF_CM_DECLARE_NOCOPY(SecureCachingConnectionFactoryObj);
};

}}

#endif /* SECURECACHINGCONNECTIONFACTORYOBJ_H_ */
