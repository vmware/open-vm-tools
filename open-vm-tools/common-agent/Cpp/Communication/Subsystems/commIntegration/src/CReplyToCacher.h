...
class CReplyToCacher :
	public TCafSubSystemObjectRoot<CReplyToCacher>,
	public IBean,
	public IIntegrationComponent {
public:
	CReplyToCacher();
	virtual ~CReplyToCacher();

	CAF_DECLARE_OBJECT_IDENTIFIER(_sObjIdCommIntegrationReplyToCacher)

	CAF_BEGIN_INTERFACE_MAP(CReplyToCacher)
...
private:
	CAF_CM_CREATE;
	CAF_CM_DECLARE_NOCOPY(CReplyToCacher);
};

}

#endif // #ifndef CReplyToCacher_h_
