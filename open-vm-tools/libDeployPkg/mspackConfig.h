 ...
 * for different flavours of linux/unix using -target in gcc
 */
 ...
 * PACKAGE_VERSION and VERSION should not be defined here, since they will be in conflict
 * with open-vm-tools definitions.
 */
