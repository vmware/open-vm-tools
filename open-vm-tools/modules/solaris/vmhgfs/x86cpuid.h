...
FLAGDEFA(  1, ECX, INTEL,  22,  1, MOVBE,               YES, HOST,   0, TRUE,  MOVBE)     \
...
FLAGDEF(   4, EAX, INTEL,   8,  1, CACHE_SELF_INIT,     NA,  IGNORE, 0, FALSE)            \
FLAGDEF(   4, EAX, INTEL,   9,  1, CACHE_FULLY_ASSOC,   NA,  IGNORE, 0, FALSE)            \
...
FIELDDEF(  4, ECX, INTEL,   0, 32, CACHE_SETS,          NA,  IGNORE, 0, FALSE)            \
FLAGDEF(   4, EDX, INTEL,   0,  1, CACHE_WBINVD_NOT_GUARANTEED, NA,  IGNORE, 0, FALSE)    \
FLAGDEF(   4, EDX, INTEL,   1,  1, CACHE_IS_INCLUSIVE,  NA,  IGNORE, 0, FALSE)
...
FIELDDEF(  B, EAX, INTEL,   0,  5, MASK_WIDTH,          NA,  IGNORE, 0, FALSE)            \
FIELDDEF(  B, EBX, INTEL,   0, 16, CPUS_SHARING_LEVEL,  NA,  IGNORE, 0, FALSE)            \
FIELDDEF(  B, ECX, INTEL,   0,  8, LEVEL_NUMBER,        NA,  IGNORE, 0, FALSE)            \
FIELDDEF(  B, ECX, INTEL,   8,  8, LEVEL_TYPE,          NA,  IGNORE, 0, FALSE)            \
FIELDDEF(  B, EDX, INTEL,   0, 32, X2APIC_ID,           NA,  IGNORE, 0, FALSE)
