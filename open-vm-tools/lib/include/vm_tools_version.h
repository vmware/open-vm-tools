...
#ifndef RC_INVOKED
#define   TOOLS_VERSION_PLIERS_PATCH4 TOOLS_VERSION_TO_UINT(TOOLS_VERSION_PLIERS_PATCH4_V)
#endif /* RC_INVOKED */
#define   TOOLS_VERSION_PLIERS_PATCH4_V_MJR  12
#define   TOOLS_VERSION_PLIERS_PATCH4_V_MNR  5
#define   TOOLS_VERSION_PLIERS_PATCH4_V_BASE 4

#define   TOOLS_VERSION_CURRENT        TOOLS_VERSION_PLIERS_PATCH4
#define   TOOLS_VERSION_CURRENT_STR    TOOLS_VERSION_TO_STR(TOOLS_VERSION_PLIERS_PATCH4)
#define   TOOLS_VERSION_CURRENT_CSV    TOOLS_VERSION_TO_CSV(TOOLS_VERSION_PLIERS_PATCH4)
