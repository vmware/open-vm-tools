...
#define   TOOLS_VERSION_CURRENT        TOOLS_VERSION_MNNEXT_RELEASE
#define   TOOLS_VERSION_CURRENT_STR    TOOLS_VERSION_TO_STR(TOOLS_VERSION_MNNEXT_RELEASE)
#define   TOOLS_VERSION_CURRENT_CSV    TOOLS_VERSION_TO_CSV(TOOLS_VERSION_MNNEXT_RELEASE)
