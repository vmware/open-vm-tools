...
#define PRODUCT_VERSION_WORKSTATION_25H2 PRODUCT_WORKSTATION_BRIEF_NAME " " DESKTOP_HYPERVISOR_RELEASE_SUFFIX
...
#define PRODUCT_VERSION_MAC_DESKTOP_25H2 PRODUCT_MAC_DESKTOP_BRIEF_NAME " " DESKTOP_HYPERVISOR_RELEASE_SUFFIX
