 ...
 */
   ...
   #define PRODUCT_VERSION    4,2,0,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define ESX_RELEASE_PATCH "5"  /* 0 = experimental */
...
#define VIEW_CLIENT_VERSION "4.2.0"
