 ...
 */
   ...
   #define PRODUCT_VERSION    6,9,3,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VPX_VERSION_THIRD_PARTY VPX_VERSION_MAJOR VPX_VERSION_MINOR \
                                VPX_VERSION_MAINT
#define VPX_VERSION_NUMERIC 6,9,3,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VCDB_CURRENT_SCHEMA_VERSION           693 // from PitCADatabase.h
...
#define VPXD_VDB_DB_VERSION_ID            693
...
#define INTEGRITY_VERSION "6.9.3" /* Should use VPX_VERSION? */
