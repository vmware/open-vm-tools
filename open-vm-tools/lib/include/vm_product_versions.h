 ...
 */
   ...
   #define PRODUCT_VERSION    6,8,9,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VCDB_CURRENT_SCHEMA_VERSION           689 // from PitCADatabase.h
...
#define VPXD_VDB_DB_VERSION_ID            689
...
#define INTEGRITY_VERSION "6.8.9" /* Should use VPX_VERSION? */
...
#define PRODUCT_ESX_LICENSE_FILE_VERSION "6.8.0.4"
