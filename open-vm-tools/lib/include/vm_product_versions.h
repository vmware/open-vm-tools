 ...
 */
   ...
   #define PRODUCT_VERSION    11,2,0,PRODUCT_BUILD_NUMBER_NUMERIC   /* VMRC_VERSION_NUMBER below has to match this */
   ...
   #define PRODUCT_VERSION    7,0,1,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VMRC_VERSION_NUMBER "11.2.0" /* this version number should always match real VMRC version number */
#define VMRC_VERSION "11.2.0"
...
#define VPX_VERSION_THIRD_PARTY VPX_VERSION_MAJOR VPX_VERSION_MINOR \
                                VPX_VERSION_MAINT
#define VPX_VERSION_NUMERIC 7,0,1,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VCDB_CURRENT_SCHEMA_VERSION           701 // from PitCADatabase.h
...
#  elif defined(VMX86_VPX)
#    define PRODUCT_LICENSE_VERSION "7.0"
#    define PRODUCT_LICENSE_FILE_VERSION "7.0.0.2"
#  elif defined(VMX86_WBC)
#    define PRODUCT_LICENSE_VERSION "1.0"
#  elif defined(VMX86_SDK)
#    define PRODUCT_LICENSE_VERSION "1.0"
...
#define PRODUCT_ESX_LICENSE_FILE_VERSION "7.0.0.7"
