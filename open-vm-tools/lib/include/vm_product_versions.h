 ...
 */
   ...
   #define PRODUCT_VERSION    6,8,8,PRODUCT_BUILD_NUMBER_NUMERIC
...
#define VCDB_CURRENT_SCHEMA_VERSION           688 // from PitCADatabase.h
...
#define VPXD_VDB_DB_VERSION_ID            688
...
#define INTEGRITY_VERSION "6.8.8" /* Should use VPX_VERSION? */
