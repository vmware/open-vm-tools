...
static struct xRef {
    ...
    *         Katakana
    */
   { 15, WINUNDEF, STRING_ENCODING_JIS_X0201, UNSUPPORTED, 0,
    ...
    */
   { 16, WINUNDEF, STRING_ENCODING_JIS_ENCODING, UNSUPPORTED, 0,
    ...
    */
   { 18, 20932, STRING_ENCODING_EUC_JP, UNSUPPORTED, 2,
    ...
    */
   { 18, 51932, STRING_ENCODING_EUC_JP, UNSUPPORTED, 2,
      { "Extended_UNIX_Code_Packed_Format_for_Japanese", "csEUCPkdFmtJapanese",
        "EUC-JP", NULL }
   },
   /*
    ...
    * Source: ECMA registry
    */
   { 20, WINUNDEF, STRING_ENCODING_BS_4730, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 22, WINUNDEF, STRING_ENCODING_IT, UNSUPPORTED, 0,
      { "IT", "iso-ir-15", "ISO646-IT", "csISO15Italian", NULL }
   },
   /*
    * Source: ECMA registry
    */
   { 23, WINUNDEF, STRING_ENCODING_ES, UNSUPPORTED, 0,
      { "ES", "iso-ir-17", "ISO646-ES", "csISO17Spanish", NULL }
   },
   /*
    * Source: ECMA registry
    */
   { 24, WINUNDEF, STRING_ENCODING_DIN_66003, UNSUPPORTED, 0,
      { "DIN_66003", "iso-ir-21", "de", "ISO646-DE", "csISO21German", NULL }
   },
   /*
    * Source: ECMA registry
    */
   { 25, WINUNDEF, STRING_ENCODING_NS_4551_1, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 26, WINUNDEF, STRING_ENCODING_NF_Z_62_010, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 35, WINUNDEF, STRING_ENCODING_SEN_850200_B, UNSUPPORTED, 0,
    ...
    */
   { 37, 50225, STRING_ENCODING_ISO_2022_KR, UNSUPPORTED, 0,
      { "ISO-2022-KR", "csISO2022KR", NULL }
   },
   /*
    * Source: RFC-1557 (see also KS_C_5861-1992)
    */
   { 38, 51949, STRING_ENCODING_EUC_KR, UNSUPPORTED, 0,
      { "EUC-KR", "csEUCKR", NULL }
   },
   /*
    * Source: RFC-1468 (see also RFC-2237)
    */
   { 39, 50220, STRING_ENCODING_ISO_2022_JP, UNSUPPORTED, 0,
      { "ISO-2022-JP", "csISO2022JP", NULL }
   },
   /*
    * Source: VMware
    */
   { MIBUNDEF, WINUNDEF, STRING_ENCODING_ISO_2022_JP_1, UNSUPPORTED, 0,
      { "ISO-2022-JP-1", NULL }
   },
   /*
    * Source: RFC-1554
    */
   { 40, WINUNDEF, STRING_ENCODING_ISO_2022_JP_2, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 46, WINUNDEF, STRING_ENCODING_NF_Z_62_010__1973_, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 57, 20936, STRING_ENCODING_GB_2312_80, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 60, WINUNDEF, STRING_ENCODING_PT2, UNSUPPORTED, 0,
      { "PT2", "iso-ir-84", "ISO646-PT2", "csISO84Portuguese2", NULL }
   },
   /*
    * Source: ECMA registry
    */
   { 61, WINUNDEF, STRING_ENCODING_ES2, UNSUPPORTED, 0,
    ...
    * Source: ECMA registry
    */
   { 78, WINUNDEF, STRING_ENCODING_CSA_Z243_4_1985_1, UNSUPPORTED, 0,
    ...
    */
   { 99, WINUNDEF, STRING_ENCODING_DS_2089, UNSUPPORTED, 0,
    ...
    * Source: RFC-1922
    */
   { 104, 50227, STRING_ENCODING_ISO_2022_CN, UNSUPPORTED, 0,
      { "ISO-2022-CN", NULL }
   },
   /*
    * Source: RFC-1922
    */
   { 105, WINUNDEF, STRING_ENCODING_ISO_2022_CN_EXT, UNSUPPORTED, 0,
    ...
    */
   { 111, 874, STRING_ENCODING_ISO_8859_15, SUPPORTED, 0,
      { "ISO-8859-15", "ISO_8859-15", "Latin-9", NULL }
   },
   /*
    * Source: ISO
    */
   { 112, WINUNDEF, STRING_ENCODING_ISO_8859_16, UNSUPPORTED, 0,
    ...
    */
   { 114, 54936, STRING_ENCODING_GB_18030, UNSUPPORTED, 0,
      { "GB18030", NULL }
   },
   /*
    ...
    *    [Veremeev, Kikkarin]
    */
   { 119, WINUNDEF, STRING_ENCODING_KZ_1048, UNSUPPORTED, 0,
    ...
    */
   { 2004, WINUNDEF, STRING_ENCODING_HP_ROMAN8, UNSUPPORTED, 0,
    ...
    */
   { 2008, WINUNDEF, STRING_ENCODING_DEC_MCS, UNSUPPORTED, 0,
      { "DEC-MCS", "dec", "csDECMCS", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2009, 850, STRING_ENCODING_IBM850, UNSUPPORTED, 0,
    ...
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2013, 862, STRING_ENCODING_IBM862, UNSUPPORTED, 0,
    ...
    */
   { 2025, WINUNDEF, STRING_ENCODING_GB_2312, UNSUPPORTED, 0,
    ...
    */
   { 2027, WINUNDEF, STRING_ENCODING_MACINTOSH, UNSUPPORTED, 0,
      { "macintosh", "mac", "csMacintosh", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2028, 37, STRING_ENCODING_IBM037, UNSUPPORTED, 0,
    ...
    */
   { 2029, WINUNDEF, STRING_ENCODING_IBM038, UNSUPPORTED, 0,
      { "IBM038", "EBCDIC-INT", "cp038", "csIBM038", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2030, 20273, STRING_ENCODING_IBM273, UNSUPPORTED, 0,
      { "IBM273", "CP273", "csIBM273", NULL }
   },
   /*
    * Source: IBM 3174 Character Set Ref, GA27-3831-02, March 1990
    */
   { 2031, WINUNDEF, STRING_ENCODING_IBM274, UNSUPPORTED, 0,
      { "IBM274", "EBCDIC-BE", "CP274", "csIBM274", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2032, WINUNDEF, STRING_ENCODING_IBM275, UNSUPPORTED, 0,
      { "IBM275", "EBCDIC-BR", "cp275", "csIBM275", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2033, 20277, STRING_ENCODING_IBM277, UNSUPPORTED, 0,
      { "IBM277", "EBCDIC-CP-DK", "EBCDIC-CP-NO", "csIBM277", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2034, 20278, STRING_ENCODING_IBM278, UNSUPPORTED, 0,
      { "IBM278", "CP278", "ebcdic-cp-fi", "ebcdic-cp-se", "csIBM278", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2035, 20280, STRING_ENCODING_IBM280, UNSUPPORTED, 0,
      { "IBM280", "CP280", "ebcdic-cp-it", "csIBM280", NULL }
   },
   /*
    * Source: IBM 3174 Character Set Ref, GA27-3831-02, March 1990
    */
   { 2036, WINUNDEF, STRING_ENCODING_IBM281, UNSUPPORTED, 0,
      { "IBM281", "EBCDIC-JP-E", "cp281", "csIBM281", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2037, 20284, STRING_ENCODING_IBM284, UNSUPPORTED, 0,
      { "IBM284", "CP284", "ebcdic-cp-es", "csIBM284", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2038, 20285, STRING_ENCODING_IBM285, UNSUPPORTED, 0,
      { "IBM285", "CP285", "ebcdic-cp-gb", "csIBM285", NULL }
   },
   /*
    * Source: IBM 3174 Character Set Ref, GA27-3831-02, March 1990
    */
   { 2039, 20290, STRING_ENCODING_IBM290, UNSUPPORTED, 0,
      { "IBM290", "cp290", "EBCDIC-JP-kana", "csIBM290", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2040, 20297, STRING_ENCODING_IBM297, UNSUPPORTED, 0,
    ...
    *         IBM NLS RM p 11-11
    */
   { 2041, 20420, STRING_ENCODING_IBM420, UNSUPPORTED, 0,
      { "IBM420", "cp420", "ebcdic-cp-ar1", "csIBM420", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2042, 20423, STRING_ENCODING_IBM423, UNSUPPORTED, 0,
      { "IBM423", "cp423", "ebcdic-cp-gr", "csIBM423", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2043, 20424, STRING_ENCODING_IBM424, UNSUPPORTED, 0,
      { "IBM424", "cp424", "ebcdic-cp-he", "csIBM424", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2011, 437, STRING_ENCODING_IBM437, UNSUPPORTED, 0,
      { "IBM437", "cp437", "437", "csPC8CodePage437", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2044, 500, STRING_ENCODING_IBM500, UNSUPPORTED, 0,
      { "IBM500", "CP500", "ebcdic-cp-be", "ebcdic-cp-ch", "csIBM500", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2045, WINUNDEF, STRING_ENCODING_IBM851, UNSUPPORTED, 0,
      { "IBM851", "cp851", "851", "csIBM851", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2010, 852, STRING_ENCODING_IBM852, UNSUPPORTED, 0,
      { "IBM852", "cp852", "852", "csPCp852", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2046, 855, STRING_ENCODING_IBM855, UNSUPPORTED, 0,
      { "IBM855", "cp855", "855", "csIBM855", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2047, 857, STRING_ENCODING_IBM857, UNSUPPORTED, 0,
      { "IBM857", "cp857", "857", "csIBM857", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2048, 860, STRING_ENCODING_IBM860, UNSUPPORTED, 0,
      { "IBM860", "cp860", "860", "csIBM860", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2049, 861, STRING_ENCODING_IBM861, UNSUPPORTED, 0,
      { "IBM861", "cp861", "861", "cp-is", "csIBM861", NULL }
   },
   /*
    * Source: IBM Keyboard layouts and code pages, PN 07G4586 June 1991
    */
   { 2050, 863, STRING_ENCODING_IBM863, UNSUPPORTED, 0,
      { "IBM863", "cp863", "863", "csIBM863", NULL }
   },
   /*
    * Source: IBM Keyboard layouts and code pages, PN 07G4586 June 1991
    */
   { 2051, 864, STRING_ENCODING_IBM864, UNSUPPORTED, 0,
      { "IBM864", "cp864", "csIBM864", NULL }
   },
   /*
    * Source: IBM DOS 3.3 Ref (Abridged), 94X9575 (Feb 1987)
    */
   { 2052, 865, STRING_ENCODING_IBM865, UNSUPPORTED, 0,
      { "IBM865", "cp865", "865", "csIBM865", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2053, WINUNDEF, STRING_ENCODING_IBM868, UNSUPPORTED, 0,
      { "IBM868", "CP868", "cp-ar", "csIBM868", NULL }
   },
   /*
    * Source: IBM Keyboard layouts and code pages, PN 07G4586 June 1991
    */
   { 2054, 869, STRING_ENCODING_IBM869, UNSUPPORTED, 0,
      { "IBM869", "cp869", "869", "cp-gr", "csIBM869", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2055, 870, STRING_ENCODING_IBM870, UNSUPPORTED, 0,
      { "IBM870", "CP870", "ebcdic-cp-roece", "ebcdic-cp-yu", "csIBM870", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2056, 20871, STRING_ENCODING_IBM871, UNSUPPORTED, 0,
      { "IBM871", "CP871", "ebcdic-cp-is", "csIBM871", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2057, 20880, STRING_ENCODING_IBM880, UNSUPPORTED, 0,
      { "IBM880", "cp880", "EBCDIC-Cyrillic", "csIBM880", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2058, WINUNDEF, STRING_ENCODING_IBM891, UNSUPPORTED, 0,
      { "IBM891", "cp891", "csIBM891", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2059, WINUNDEF, STRING_ENCODING_IBM903, UNSUPPORTED, 0,
      { "IBM903", "cp903", "csIBM903", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2060, WINUNDEF, STRING_ENCODING_IBM904, UNSUPPORTED, 0,
      { "IBM904", "cp904", "904", "csIBBM904", NULL }
   },
   /*
    * Source: IBM 3174 Character Set Ref, GA27-3831-02, March 1990
    */
   { 2061, 20905, STRING_ENCODING_IBM905, UNSUPPORTED, 0,
      { "IBM905", "CP905", "ebcdic-cp-tr", "csIBM905", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2062, WINUNDEF, STRING_ENCODING_IBM918, UNSUPPORTED, 0,
      { "IBM918", "CP918", "ebcdic-cp-ar2", "csIBM918", NULL }
   },
   /*
    * Source: IBM NLS RM Vol2 SE09-8002-01, March 1990
    */
   { 2063, 1026, STRING_ENCODING_IBM1026, UNSUPPORTED, 0,
    ...
    * Source: IBM 3270 Char Set Ref Ch 10, GA27-2837-9, April 1987 
    */
   { 2065, WINUNDEF, STRING_ENCODING_EBCDIC_AT_DE_A, UNSUPPORTED, 0,
    ...
    */
   { 2084, 20866, STRING_ENCODING_KOI8_R, UNSUPPORTED, 0,
      { "KOI8-R", "csKOI8R", NULL }
   },
   /*
    ...
    */
   { 2086, 866, STRING_ENCODING_IBM866, UNSUPPORTED, 0,
      { "IBM866", "cp866", "866", "csIBM866", NULL }
   },
   /*
    * Source: HP PCL 5 Comparison Guide (P/N 5021-0329) pp B-13, 1996
    */
   { 2087, 775, STRING_ENCODING_IBM775, UNSUPPORTED, 0,
      { "IBM775", "cp775", "csPC775Baltic", NULL }
   },
   /*
    * Source: RFC 2319
    */
   { 2088, 21866, STRING_ENCODING_KOI8_U, UNSUPPORTED, 0,
      { "KOI8-U", NULL }
   },
   /*
    ...
    *   [Mahdi]
    */
   { 2089, 858, STRING_ENCODING_IBM00858, UNSUPPORTED, 0,
    ...
    *   [Mahdi]
    */
   { 2090, 20924, STRING_ENCODING_IBM00924, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2091, 1140, STRING_ENCODING_IBM01140, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2092, 1141, STRING_ENCODING_IBM01141, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2093, 1142, STRING_ENCODING_IBM01142, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2094, 1143, STRING_ENCODING_IBM01143, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2095, 1144, STRING_ENCODING_IBM01144, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2096, 1145, STRING_ENCODING_IBM01145, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2097, 1146, STRING_ENCODING_IBM01146, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2098, 1147, STRING_ENCODING_IBM01147, UNSUPPORTED, 0,
    ...
    *    [Mahdi]
    */
   { 2099, 1148, STRING_ENCODING_IBM01148, UNSUPPORTED, 0,
    ...
    *        pdf/cp01047z.pdf
    */
   { 2102, 1047, STRING_ENCODING_IBM1047, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 720, STRING_ENCODING_WINDOWS_720, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 875, STRING_ENCODING_WINDOWS_875, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 10000, STRING_ENCODING_WINDOWS_10000, UNSUPPORTED, 0,
      { "Windows-10000", NULL }
   },
   /*
    ...
    */
   { MIBUNDEF, 10006, STRING_ENCODING_WINDOWS_10006, UNSUPPORTED, 0,
      { "Windows-10006", "x-mac-greek", NULL }
   },
   /*
    * x-mac-cyrillic: Cyrillic (Mac)
    */
   { MIBUNDEF, 10007, STRING_ENCODING_WINDOWS_10007, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 10029, STRING_ENCODING_WINDOWS_10029, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 10081, STRING_ENCODING_WINDOWS_10081, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 21025, STRING_ENCODING_WINDOWS_21025, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 38598, STRING_ENCODING_WINDOWS_38598, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 50221, STRING_ENCODING_WINDOWS_50221, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 50222, STRING_ENCODING_WINDOWS_50222, UNSUPPORTED, 0,
    ...
    */
   { MIBUNDEF, 51936, STRING_ENCODING_WINDOWS_51936, UNSUPPORTED, 0,
