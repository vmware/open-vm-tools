...
/*
 * toolboxgtk_version.h --
 *
 * Version definitions for the GTK toolbox UI.
 */

#ifndef _TOOLBOXGTK_VERSION_H_
#define _TOOLBOXGTK_VERSION_H_
...
#define TOOLBOXGTK_VERSION_COMMAS   TOOLS_VERSION_EXT_CURRENT_CSV
#define TOOLBOXGTK_VERSION_STRING   TOOLS_VERSION_EXT_CURRENT_STR

#endif /* _TOOLBOXGTK_VERSION_H_ */
